...
public class FindByReceiverImpl implements FindByReceiver {

    private final MessageGateway messageGateway;

    @Override
    public List<Message> query(Long receiverId) {
        var messages = messageGateway.findReceiverMessages(receiverId);
